...
class NewPublishContent extends StatefulWidget {
  NewPublishContent({
  ...
  @override
  _NewPublishContentState createState() => _NewPublishContentState();
}

class _NewPublishContentState extends State<NewPublishContent> {
  ...
  Future getMoreData() async {
    print("run get more data in new publish content tab");
    this.isLoadingMore = true;
