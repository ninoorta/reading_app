...
class NewUpdateContent extends StatefulWidget {
  NewUpdateContent({
  ...
  @override
  _NewUpdateContentState createState() => _NewUpdateContentState();
}

class _NewUpdateContentState extends State<NewUpdateContent> {
